      ...
      body: ContentWidth(
        ...
        child: FutureBuilder<_Report>(
          ...
          builder: (context, snap) {
            ...
            // The charts want width and the summaries want a column; on a
            // tablet they stop competing for the same one.
            final wide = !context.window.isCompact;
            final month = <Widget>[
              ...
              return Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      padding: const EdgeInsets.fromLTRB(
                          Space.md, Space.md, Space.lg, Space.xxl),
                      children: summaries,
                    ),
                  ),
                ],
